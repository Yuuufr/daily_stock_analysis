...
# 量化模块初始化
from src.quant.integration import initialize_quant_module, QuantIntegration
initialize_quant_module()

# 启动周末训练调度（可选）
_quant_scheduler = QuantIntegration.setup_weekend_training()
